...
def validate_required_files(repository_root: Path | None = None) -> list[str]:
    ...
    required = [
        ...
        repository_root / "back-matter/appendix-a-production-rollout.md",
        repository_root / "back-matter/appendix-b-evaluation-test-plan.md",
        repository_root / "back-matter/appendix-c-security-review.md",
